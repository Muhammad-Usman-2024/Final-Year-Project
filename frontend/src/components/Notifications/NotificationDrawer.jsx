...
import { closeDrawer, fetchNotifications, markAllRead, markOneRead } from '../../store/notificationSlice';
                ...
                <div className="flex-1 overflow-y-auto overscroll-contain space-y-1 p-3">
                    ...
                    {!isLoading && recentItems.length === 0 && (
                        <div className="flex flex-col items-center justify-center h-full gap-4 text-center p-8">
                            <div className="w-16 h-16 rounded-full bg-white/5 flex items-center justify-center text-sm font-black">
                                SY
                            </div>
                        ...
                        return (
                            ...
                            >
                                <div className="flex gap-3">
                                    <span className={`w-9 h-9 rounded-lg border shrink-0 mt-0.5 text-[10px] font-black flex items-center justify-center ${cfg.color}`}>
                                        {cfg.code}
                                    </span>
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-start justify-between gap-2 mb-1">
                                            ...
                                            {!notif.isRead && <div className="w-2 h-2 rounded-full bg-accent-blue shrink-0 mt-1.5 shadow-[0_0_6px_rgba(59,130,246,0.8)]" />}
                                        </div>
